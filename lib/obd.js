...
/**
 * Set the writeDelay. delay between writes. Default to 50,  
 * 
 * @param {number} miliseconds delay between writes.
 * @default 50
 */
OBDReader.prototype.setWriteDelay = function (writeDelay) {
